...
public class m0<T> extends k.b.b<T> implements CoroutineStackFrame {
    @JvmField
    @NotNull

    /* renamed from: d  reason: collision with root package name */
    public final Continuation<T> f29451d;

    /* JADX WARN: Multi-variable type inference failed */
    public m0(@NotNull CoroutineContext coroutineContext, @NotNull Continuation<? super T> continuation) {
        super(coroutineContext, true, true);
        this.f29451d = continuation;
    }
    ...
    public void f0(@Nullable Object obj) {
        m.g(IntrinsicsKt__IntrinsicsJvmKt.intercepted(this.f29451d), k.b.l0.a(obj, this.f29451d), null, 2, null);
    }

    @Override // kotlin.coroutines.jvm.internal.CoroutineStackFrame
    @Nullable
    public final CoroutineStackFrame getCallerFrame() {
        Continuation<T> continuation = this.f29451d;
    ...
    public void r1(@Nullable Object obj) {
        Continuation<T> continuation = this.f29451d;
        continuation.resumeWith(k.b.l0.a(obj, continuation));
    }
