...
public final class uc implements ViewBinding {
    ...
    private final LinearLayout f23422a;
    @NonNull
    ...
    private uc(@NonNull LinearLayout linearLayout, @NonNull LoadImageView loadImageView, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TextView textView3) {
    }
