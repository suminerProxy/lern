...
public final class RxDataStoreDelegateKt$rxDataStore$1<T> extends Lambda implements Function1<Context, List<? extends DataMigration<T>>> {
    public static final RxDataStoreDelegateKt$rxDataStore$1 INSTANCE = null;
