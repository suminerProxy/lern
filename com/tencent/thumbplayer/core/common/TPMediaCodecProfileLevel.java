...
public final class TPMediaCodecProfileLevel {
    ...
    public static final HashMap<Integer, Integer> av1LumaSampleMap = null;
    public static final HashMap<Integer, Integer> avcLumaSampleMap = null;
    public static final HashMap<Integer, Integer> hevcLumaSampleMap = null;
    public static final HashMap<Integer, Integer> vp9LumaSampleMap = null;

    public static int getAV1MaxLumaSample(int i2) {
    }

    public static int getAVCMaxLumaSample(int i2) {
    }

    public static int getHEVCMaxLumaSample(int i2) {
    }

    public static int getVP9MaxLumaSample(int i2) {
    }
}
