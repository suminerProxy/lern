...
public final class MultiDex {
    ...
    private static ArrayList<Object> installDexes(ClassLoader classLoader, String str, String str2, int i2, boolean z, boolean z2) {
        ArrayList<File> splitPaths = splitPaths(str);
        File file = new File(str2);
        try {
            try {
                try {
                    try {
                        return V19.install(classLoader, findField(classLoader, "pathList"), splitPaths, file, i2, z, z2);
                ...
                try {
                    try {
                        return V4.install(classLoader, findField(classLoader, "path"), splitPaths, file, i2);
                    } catch (IOException e6) {
                        e6.printStackTrace();
                        return null;
    ...
    private static void preparetoinstallDexes(ClassLoader classLoader, int i2) {
        try {
            try {
                try {
                    try {
                        prepareexpandFieldArray(findField(classLoader, "pathList").get(classLoader), "dexElements", i2);
                    } catch (IllegalAccessException e2) {
                        e2.printStackTrace();
                    }
                } catch (IllegalArgumentException e3) {
            ...
            try {
                prepareexpandFieldArray(classLoader, "mPaths", i2);
                prepareexpandFieldArray(classLoader, "mFiles", i2);
                prepareexpandFieldArray(classLoader, "mZips", i2);
                prepareexpandFieldArray(classLoader, "mDexs", i2);
            } catch (IllegalAccessException e4) {
                e4.printStackTrace();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void expandFieldArray(Object obj, String str, Object[] objArr, int i2) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        if (str.equals("dexElements")) {
            System.arraycopy(objArr, 0, injectPathListObj, injectDexBeginIndex + i2, objArr.length);
        } else if (str.equals("mPaths")) {
            System.arraycopy(objArr, 0, injectPathsObj, injectDexBeginIndex + i2, objArr.length);
        } else if (str.equals("mFiles")) {
            System.arraycopy(objArr, 0, injectFilesObj, injectDexBeginIndex + i2, objArr.length);
        } else if (str.equals("mDexs")) {
            System.arraycopy(objArr, 0, injectDexsObj, injectDexBeginIndex + i2, objArr.length);
        } else if (str.equals("mZips")) {
            System.arraycopy(objArr, 0, injectZipsObj, injectDexBeginIndex + i2, objArr.length);
        }
    }

    private static void prepareexpandFieldArray(Object obj, String str, int i2) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        Object[] objArr = (Object[]) findField(obj, str).get(obj);
        Object[] objArr2 = (Object[]) Array.newInstance(objArr.getClass().getComponentType(), objArr.length + i2);
        ...
        if (Build.VERSION.SDK_INT == 28 && hasInjected == 0 && objArr.length > 1) {
            ...
            System.arraycopy(objArr, objArr.length - 1, objArr2, (i2 + objArr.length) - 1, 1);
        } else {
    ...
    private static final class V19 {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static ArrayList<Object> install(ClassLoader classLoader, Field field, List<File> list, File file, int i2, boolean z, boolean z2) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException {
            Object obj = field.get(classLoader);
            ArrayList arrayList = new ArrayList();
            Object[] makeDexElements = makeDexElements(obj, new ArrayList(list), file, arrayList);
            if (makeDexElements == null || makeDexElements.length != list.size()) {
            ...
            MultiDex.expandFieldArray(obj, "dexElements", makeDexElements, i2);
            if (arrayList.size() > 0) {
                Iterator it = arrayList.iterator();
                while (it.hasNext()) {
                    IOException iOException = (IOException) it.next();
    ...
    private static final class V4 {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static ArrayList<Object> install(ClassLoader classLoader, Field field, List<File> list, File file, int i2) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, IOException {
            int size = list.size();
            StringBuilder sb = new StringBuilder((String) field.get(classLoader));
            String[] strArr = new String[size];
            File[] fileArr = new File[size];
            ...
            field.set(classLoader, sb.toString());
            MultiDex.expandFieldArray(classLoader, "mPaths", strArr, i2);
            MultiDex.expandFieldArray(classLoader, "mFiles", fileArr, i2);
            MultiDex.expandFieldArray(classLoader, "mZips", zipFileArr, i2);
            MultiDex.expandFieldArray(classLoader, "mDexs", dexFileArr, i2);
            if (arrayList.size() == 0) {
                return null;
            }
            return arrayList;
