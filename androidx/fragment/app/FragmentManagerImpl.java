        ...
        if (animationOrAnimator.animation != null) {
            ...
            endViewTransitionAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: androidx.fragment.app.FragmentManagerImpl.3
                ...
                public void onAnimationEnd(Animation animation) {
                    viewGroup.post(new Runnable(this) { // from class: androidx.fragment.app.FragmentManagerImpl.3.1
    ...
    public int allocBackStackIndex(BackStackRecord backStackRecord) {
        ...
        synchronized (this) {
            ...
            if (arrayList2 != null && arrayList2.size() > 0) {
                int intValue = this.mAvailBackStackIndices.remove(arrayList.size() - 1).intValue();
                if (DEBUG) {
    ...
    */
    ...
    public void restoreSaveState(Parcelable parcelable) {
        ...
        for (Fragment fragment : this.mNonConfig.getRetainedFragments()) {
            if (DEBUG) {
                r0 = "restoreSaveState: re-attaching retained " + fragment;
            }
            ...
            if (fragmentState == null) {
                if (DEBUG) {
                    String str = "Discarding retained Fragment " + fragment + " that was not found in the set of active Fragments " + fragmentManagerState.mActive;
                }
                moveToState(fragment, 1, 0, 0, false);
                fragment.mRemoving = true;
        ...
        while (it2.hasNext()) {
            ...
            if (next != null) {
                ...
                if (DEBUG) {
                    String str2 = "restoreSaveState: active (" + instantiate.mWho + "): " + instantiate;
                }
        ...
        if (arrayList != null) {
            ...
            while (it3.hasNext()) {
                ...
                if (fragment3 == null) {
                    throwException(new IllegalStateException("No instantiated fragment for (" + next2 + ChineseToPinyinResource.Field.RIGHT_BRACKET));
                }
                fragment3.mAdded = true;
                if (DEBUG) {
                    String str3 = "restoreSaveState: added (" + next2 + "): " + fragment3;
                }
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            while (true) {
                ...
                if (DEBUG) {
                    String str4 = "restoreAllState: back stack #" + i2 + " (index " + instantiate2.mIndex + "): " + instantiate2;
                    PrintWriter printWriter = new PrintWriter(new LogWriter("FragmentManager"));
        ...
        if (str5 != null) {
            Fragment fragment4 = this.mActive.get(str5);
