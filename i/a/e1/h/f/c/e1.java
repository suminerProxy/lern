...
public final class e1<T> extends i.a.e1.h.f.c.a<T, T> {
    public final i.a.e1.g.o<? super Throwable, ? extends T> c;
    ...
    public static final class a<T> implements i.a.e1.c.c0<T>, i.a.e1.d.f {
        ...
        public i.a.e1.d.f f27292d;

        public a(i.a.e1.c.c0<? super T> actual, i.a.e1.g.o<? super Throwable, ? extends T> valueSupplier) {
        }
    ...
    public e1(i.a.e1.c.f0<T> source, i.a.e1.g.o<? super Throwable, ? extends T> itemSupplier) {
    }
