...
public final class DataStoreDelegateKt$dataStore$1<T> extends Lambda implements Function1<Context, List<? extends DataMigration<T>>> {
    public static final DataStoreDelegateKt$dataStore$1 INSTANCE = null;
