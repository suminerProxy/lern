...
public final class TextViewTextChangeEventObservable extends InitialValueObservable<TextViewTextChangeEvent> {
    ...
    public static final class Listener extends a implements TextWatcher {
        private final i0<? super TextViewTextChangeEvent> observer;
        private final TextView view;

        public Listener(TextView textView, i0<? super TextViewTextChangeEvent> i0Var) {
        }
    ...
    public /* bridge */ /* synthetic */ TextViewTextChangeEvent getInitialValue() {
    }

    @Override // com.jakewharton.rxbinding2.InitialValueObservable
    public void subscribeListener(i0<? super TextViewTextChangeEvent> i0Var) {
    }
