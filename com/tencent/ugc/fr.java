...
public final /* synthetic */ class fr implements Runnable {
    ...
    private final UGCVideoProcessor f14437a;
    private final UGCVideoProcessor.VideoEncodedFrameListener b;

    private fr(UGCVideoProcessor uGCVideoProcessor, UGCVideoProcessor.VideoEncodedFrameListener videoEncodedFrameListener) {
    }
