...
@DebugMetadata(c = "androidx.datastore.rxjava3.RxSharedPreferencesMigrationBuilder$build$2", f = "RxSharedPreferencesMigration.kt", i = {}, l = {108}, m = "invokeSuspend", n = {}, s = {})
...
public final class RxSharedPreferencesMigrationBuilder$build$2<T> extends SuspendLambda implements Function3<SharedPreferencesView, T, Continuation<? super T>, Object> {
    ...
    @Nullable
    public final Object invoke(@NotNull SharedPreferencesView sharedPreferencesView, T t, @Nullable Continuation<? super T> continuation) {
    }
