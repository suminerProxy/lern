...
public final class p<T, R> extends i.a.e1.h.f.c.a<T, R> {
    public final i.a.e1.g.o<? super T, i.a.e1.c.h0<R>> c;
    ...
    public static final class a<T, R> implements i.a.e1.c.c0<T>, i.a.e1.d.f {
        ...
        public i.a.e1.d.f f27320d;

        public a(i.a.e1.c.c0<? super R> downstream, i.a.e1.g.o<? super T, i.a.e1.c.h0<R>> selector) {
        }
    ...
    public p(i.a.e1.c.z<T> source, i.a.e1.g.o<? super T, i.a.e1.c.h0<R>> selector) {
    }
