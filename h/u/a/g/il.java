...
public final class il implements ViewBinding {
    ...
    private il(@NonNull FrameLayout frameLayout, @NonNull UserLevelView userLevelView) {
    }
    ...
    @NonNull
    public static il d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
    }
