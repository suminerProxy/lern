...
import com.showstartfans.activity.view.wheel.DateWheelPicker;
...
public final class u8 implements ViewBinding {
    ...
    public final DateWheelPicker f23411d;
    @NonNull

    /* renamed from: e  reason: collision with root package name */
    public final View f23412e;

    private u8(@NonNull LinearLayout linearLayout, @NonNull Button button, @NonNull Button button2, @NonNull DateWheelPicker dateWheelPicker, @NonNull View view) {
    }
