...
public interface f1 {
    ...
    public static final class a {
        ...
        @Nullable
        public static Object a(@NotNull f1 f1Var, long j2, @NotNull Continuation<? super Unit> continuation) {
            if (j2 <= 0) {
        ...
        @NotNull
        public static p1 b(@NotNull f1 f1Var, long j2, @NotNull Runnable runnable, @NotNull CoroutineContext coroutineContext) {
            return c1.a().f(j2, runnable, coroutineContext);
        }
    }

    void c(long j2, @NotNull r<? super Unit> rVar);

    @NotNull
    p1 f(long j2, @NotNull Runnable runnable, @NotNull CoroutineContext coroutineContext);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated without replacement as an internal method never intended for public use")
    @Nullable
    Object n(long j2, @NotNull Continuation<? super Unit> continuation);
}
