...
public final class TextViewAfterTextChangeEventObservable extends InitialValueObservable<TextViewAfterTextChangeEvent> {
    ...
    public static final class Listener extends a implements TextWatcher {
        private final i0<? super TextViewAfterTextChangeEvent> observer;
        private final TextView view;

        public Listener(TextView textView, i0<? super TextViewAfterTextChangeEvent> i0Var) {
        }
    ...
    public /* bridge */ /* synthetic */ TextViewAfterTextChangeEvent getInitialValue() {
    }

    @Override // com.jakewharton.rxbinding2.InitialValueObservable
    public void subscribeListener(i0<? super TextViewAfterTextChangeEvent> i0Var) {
    }
