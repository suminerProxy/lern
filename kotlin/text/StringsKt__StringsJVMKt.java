...
public class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    @InlineOnly
    private static final int nativeIndexOf(String str, char c, int i2) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        return str.indexOf(c, i2);
    }

    @InlineOnly
    private static final int nativeLastIndexOf(String str, char c, int i2) {
        Intrinsics.checkNotNullParameter(str, "<this>");
    ...
    public static final boolean regionMatches(@NotNull CharSequence charSequence, int i2, @NotNull CharSequence other, int i3, int i4, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
        if ((charSequence instanceof String) && (other instanceof String)) {
            return regionMatches((String) charSequence, i2, (String) other, i3, i4, z);
        }
        return StringsKt__StringsKt.regionMatchesImpl(charSequence, i2, other, i3, i4, z);
    }
    ...
    public static final boolean startsWith(@NotNull String str, @NotNull String prefix, int i2, boolean z) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
        if (!z) {
    ...
    public static final boolean regionMatches(@NotNull String str, int i2, @NotNull String other, int i3, int i4, boolean z) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
        if (!z) {
