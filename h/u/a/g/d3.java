...
/* compiled from: ActivityPayFailBinding.java */
...
public final class d3 implements ViewBinding {
    ...
    public final LinearLayout f20938f;
    @NonNull
    ...
    private d3(@NonNull LinearLayout linearLayout, @NonNull Button button, @NonNull Button button2, @NonNull ImageView imageView, @NonNull LinearLayout linearLayout2, @NonNull LinearLayout linearLayout3, @NonNull TextView textView, @NonNull TextView textView2) {
    }
