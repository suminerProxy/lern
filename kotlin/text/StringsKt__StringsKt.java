...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    private static final int indexOf$StringsKt__StringsKt(CharSequence charSequence, CharSequence charSequence2, int i2, int i3, boolean z, boolean z2) {
        ...
        if (!z2) {
            downTo = new IntRange(RangesKt___RangesKt.coerceAtLeast(i2, 0), RangesKt___RangesKt.coerceAtMost(i3, charSequence.length()));
        } else {
            downTo = RangesKt___RangesKt.downTo(RangesKt___RangesKt.coerceAtMost(i2, getLastIndex(charSequence)), RangesKt___RangesKt.coerceAtLeast(i3, 0));
        }
        if ((charSequence instanceof String) && (charSequence2 instanceof String)) {
    ...
    public static final int lastIndexOfAny(@NotNull CharSequence charSequence, @NotNull char[] chars, int i2, boolean z) {
        ...
        int coerceAtMost = RangesKt___RangesKt.coerceAtMost(i2, getLastIndex(charSequence));
        if (coerceAtMost < 0) {
            return -1;
        }
        while (true) {
    ...
    public static final boolean regionMatchesImpl(@NotNull CharSequence charSequence, int i2, @NotNull CharSequence other, int i3, int i4, boolean z) {
        ...
        while (i5 < i4) {
            int i6 = i5 + 1;
            if (!CharsKt__CharKt.equals(charSequence.charAt(i2 + i5), other.charAt(i5 + i3), z)) {
                return false;
            }
            i5 = i6;
        }
    ...
    public static final void requireNonNegativeLimit(int i2) {
        if (!(i2 >= 0)) {
            throw new IllegalArgumentException(Intrinsics.stringPlus("Limit must be non-negative, but was ", Integer.valueOf(i2)).toString());
        }
    }
    ...
    public static final List<String> split(@NotNull CharSequence charSequence, @NotNull String[] delimiters, boolean z, int i2) {
        ...
        Iterable<IntRange> asIterable = SequencesKt___SequencesKt.asIterable(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, delimiters, 0, z, i2, 2, (Object) null));
    ...
    public static final Sequence<String> splitToSequence(@NotNull final CharSequence charSequence, @NotNull String[] delimiters, boolean z, int i2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        return SequencesKt___SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, delimiters, 0, z, i2, 2, (Object) null), new Function1<IntRange, String>() { // from class: kotlin.text.StringsKt__StringsKt$splitToSequence$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public static final Sequence<String> splitToSequence(@NotNull final CharSequence charSequence, @NotNull char[] delimiters, boolean z, int i2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        return SequencesKt___SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, delimiters, 0, z, i2, 2, (Object) null), new Function1<IntRange, String>() { // from class: kotlin.text.StringsKt__StringsKt$splitToSequence$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence charSequence, String[] strArr, int i2, final boolean z, int i3) {
        ...
        return new DelimitedRangesSequence(charSequence, i2, i3, new Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$2
            ...
            public final Pair<Integer, Integer> invoke(@NotNull CharSequence $receiver, int i4) {
                Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
                Pair access$findAnyOf = StringsKt__StringsKt.access$findAnyOf($receiver, asList, i4, z, false);
    ...
    public static final CharSequence trim(@NotNull CharSequence charSequence, @NotNull char... chars) {
        ...
        boolean z = false;
        while (i2 <= length) {
            boolean contains = ArraysKt___ArraysKt.contains(chars, charSequence.charAt(!z ? i2 : length));
            if (z) {
                if (!contains) {
                    break;
                }
    ...
    public static final String trim(@NotNull String str, @NotNull char... chars) {
        ...
        boolean z = false;
        while (i2 <= length) {
            boolean contains = ArraysKt___ArraysKt.contains(chars, str.charAt(!z ? i2 : length));
            if (z) {
                if (!contains) {
                    break;
                }
