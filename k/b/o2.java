...
public final class o2 extends CancellationException implements n0<o2> {
    @JvmField
    @NotNull
    public final n2 job;
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj != this) {
            if (obj instanceof o2) {
                o2 o2Var = (o2) obj;
                if (!Intrinsics.areEqual(o2Var.getMessage(), getMessage()) || !Intrinsics.areEqual(o2Var.job, this.job) || !Intrinsics.areEqual(o2Var.getCause(), getCause())) {
                }
            }
            return false;
        }
    ...
    public o2 createCopy() {
        if (z0.d()) {
            String message = getMessage();
            Intrinsics.checkNotNull(message);
            return new o2(message, this, this.job);
        }
        return null;
    }
}
