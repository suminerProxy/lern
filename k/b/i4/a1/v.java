...
public final class v<T> extends ContinuationImpl implements k.b.i4.j<T>, CoroutineStackFrame {
    ...
    @JvmField
    @NotNull
    public final k.b.i4.j<T> collector;
    @Nullable
    ...
    /* compiled from: SafeCollector.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u0005H\n¢\u0006\u0004\b\u0006\u0010\u0007"}, d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, AnimatedPasterJsonConfig.CONFIG_COUNT, "<anonymous parameter 1>", "Lkotlin/coroutines/CoroutineContext$Element;", "invoke", "(ILkotlin/coroutines/CoroutineContext$Element;)Ljava/lang/Integer;"}, k = 3, mv = {1, 6, 0}, xi = 48)
    /* loaded from: C:\Users\baby\Nox_share\ImageShare\dex\_data_user_0_com.showstartfans.activity_files_prodexdir_00O000ll111l_4.dex_6161784.dex */
    ...
    public v(@NotNull k.b.i4.j<? super T> jVar, @NotNull CoroutineContext coroutineContext) {
        super(s.b, EmptyCoroutineContext.INSTANCE);
        this.collector = jVar;
    ...
    private final void checkContext(CoroutineContext coroutineContext, CoroutineContext coroutineContext2, T t) {
        if (coroutineContext2 instanceof n) {
            exceptionTransparencyViolated((n) coroutineContext2, t);
        }
    ...
    public Object invokeSuspend(@NotNull Object obj) {
        ...
        if (m60exceptionOrNullimpl != null) {
            this.lastEmissionContext = new n(m60exceptionOrNullimpl);
        }
        Continuation<? super Unit> continuation = this.completion;
