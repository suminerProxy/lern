...
@DebugMetadata(c = "kotlin.sequences.SequencesKt___SequencesKt$runningFoldIndexed$1", f = "_Sequences.kt", i = {0, 1, 1, 1}, l = {2143, 2148}, m = "invokeSuspend", n = {"$this$sequence", "$this$sequence", "accumulator", MapBundleKey.MapObjKey.OBJ_SL_INDEX}, s = {"L$0", "L$0", "L$1", "I$0"})
