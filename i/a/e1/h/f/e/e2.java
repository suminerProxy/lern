...
public final class e2<T> extends i.a.e1.h.f.e.a<T, T> {
    ...
    public static final class a<T> extends AtomicInteger implements i.a.e1.c.p0<T>, i.a.e1.d.f {
        ...
        public final C0480a<T> otherObserver;
        public volatile int otherState;
        public volatile i.a.e1.h.c.p<T> queue;
        public T singleItem;

        /* compiled from: ObservableMergeWithMaybe.java */
        /* renamed from: i.a.e1.h.f.e.e2$a$a  reason: collision with other inner class name */
        /* loaded from: C:\Users\baby\Nox_share\ImageShare\dex\_data_user_0_com.showstartfans.activity_files_prodexdir_00O000ll111l_4.dex_6161784.dex */
        public static final class C0480a<T> extends AtomicReference<i.a.e1.d.f> implements i.a.e1.c.c0<T> {
            private static final long serialVersionUID = -2935427570954647017L;
            public final a<T> parent;

            public C0480a(a<T> parent) {
            }
    ...
    public e2(i.a.e1.c.i0<T> source, i.a.e1.c.f0<? extends T> other) {
    }
