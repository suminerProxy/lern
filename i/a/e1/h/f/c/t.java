...
public final class t<T> extends i.a.e1.h.f.c.a<T, T> {
    public final i.a.e1.g.b<? super T, ? super Throwable> c;
    ...
    public static final class a<T> implements i.a.e1.c.c0<T>, i.a.e1.d.f {
        ...
        public i.a.e1.d.f f27323d;

        public a(i.a.e1.c.c0<? super T> actual, i.a.e1.g.b<? super T, ? super Throwable> onEvent) {
        }
    ...
    public t(i.a.e1.c.f0<T> source, i.a.e1.g.b<? super T, ? super Throwable> onEvent) {
    }
