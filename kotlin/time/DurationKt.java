...
public final class DurationKt {
    ...
    private static final long durationOf(long j2, int i2) {
    }

    private static final long durationOfMillis(long j2) {
    }

    private static final long durationOfMillisNormalized(long j2) {
    }

    private static final long durationOfNanos(long j2) {
    }

    private static final long durationOfNanosNormalized(long j2) {
    }
    ...
    private static final long millisToNanos(long j2) {
    }

    private static final long nanosToMillis(long j2) {
    }
    ...
    private static final long m1465timeskIfJnKk(double d2, long j2) {
    }
    ...
    private static final long m1466timesmvk6XK0(int i2, long j2) {
    }
    ...
    @SinceKotlin(version = "1.6")
    @WasExperimental(markerClass = {ExperimentalTime.class})
    public static final long toDuration(double d2, @NotNull DurationUnit durationUnit) {
    }
}
