...
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final LongProgression downTo(long j2, byte b) {
        return LongProgression.Companion.fromClosedRange(j2, b, -1L);
    }
    ...
    public static final LongProgression downTo(byte b, long j2) {
        return LongProgression.Companion.fromClosedRange(b, j2, -1L);
    }
    ...
    public static final long coerceIn(long j2, @NotNull ClosedRange<Long> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
