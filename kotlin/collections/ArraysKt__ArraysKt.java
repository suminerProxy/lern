...
public class ArraysKt__ArraysKt extends ArraysKt__ArraysJVMKt {
        ...
        while (i2 < length) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt___UArraysKt.m599contentEqualskV0jMPg(((UByteArray) t).m141unboximpl(), ((UByteArray) t2).m141unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt___UArraysKt.m596contentEqualsFGO6Aew(((UShortArray) t).m401unboximpl(), ((UShortArray) t2).m401unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt___UArraysKt.m597contentEqualsKJPZfPQ(((UIntArray) t).m219unboximpl(), ((UIntArray) t2).m219unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt___UArraysKt.m601contentEqualslec5QzE(((ULongArray) t).m297unboximpl(), ((ULongArray) t2).m297unboximpl())) {
                        return false;
                    }
        ...
        while (i2 < length) {
            ...
            if (t == null) {
                ...
                if (t instanceof UByteArray) {
                    ...
                    sb.append(UArraysKt___UArraysKt.m613contentToString2csIQuQ(uByteArray != null ? uByteArray.m141unboximpl() : null));
                } else if (t instanceof UShortArray) {
                    UShortArray uShortArray = (UShortArray) t;
                    sb.append(UArraysKt___UArraysKt.m617contentToStringd6D3K8(uShortArray != null ? uShortArray.m401unboximpl() : null));
                } else if (t instanceof UIntArray) {
                    UIntArray uIntArray = (UIntArray) t;
                    sb.append(UArraysKt___UArraysKt.m616contentToStringXUkPCBk(uIntArray != null ? uIntArray.m219unboximpl() : null));
                } else if (t instanceof ULongArray) {
                    ULongArray uLongArray = (ULongArray) t;
                    sb.append(UArraysKt___UArraysKt.m619contentToStringuLth9ew(uLongArray != null ? uLongArray.m297unboximpl() : null));
                } else {
    ...
    public static final <T, R> Pair<List<T>, List<R>> unzip(@NotNull Pair<? extends T, ? extends R>[] pairArr) {
        ...
        int i2 = 0;
        while (i2 < length) {
            Pair<? extends T, ? extends R> pair = pairArr[i2];
            i2++;
