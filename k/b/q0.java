...
public interface q0 extends CoroutineContext.Element {
    @NotNull
    public static final b u0 = b.b;

    /* compiled from: CoroutineExceptionHandler.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    /* loaded from: C:\Users\baby\Nox_share\ImageShare\dex\_data_user_0_com.showstartfans.activity_files_prodexdir_00O000ll111l_4.dex_6161784.dex */
    public static final class a {
        public static <R> R a(@NotNull q0 q0Var, R r, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
        }

        @Nullable
        public static <E extends CoroutineContext.Element> E b(@NotNull q0 q0Var, @NotNull CoroutineContext.Key<E> key) {
        }

        @NotNull
        public static CoroutineContext c(@NotNull q0 q0Var, @NotNull CoroutineContext.Key<?> key) {
        }

        @NotNull
        public static CoroutineContext d(@NotNull q0 q0Var, @NotNull CoroutineContext coroutineContext) {
        }
    }
    ...
    /* loaded from: C:\Users\baby\Nox_share\ImageShare\dex\_data_user_0_com.showstartfans.activity_files_prodexdir_00O000ll111l_4.dex_6161784.dex */
    public static final class b implements CoroutineContext.Key<q0> {
